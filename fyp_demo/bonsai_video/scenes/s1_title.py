...
class Title(Scene):
    def construct(self):
        ...
        self.play(FadeIn(authors), FadeIn(inst), run_time=0.7)
        self.wait(1.8)
        self.play(FadeOut(VGroup(tree, title, sub, authors, inst)), run_time=0.9)
